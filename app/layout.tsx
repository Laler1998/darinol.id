...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: "/darinol-icon-48.png", sizes: "48x48", type: "image/png" },
      { url: "/darinol-icon-96.png", sizes: "96x96", type: "image/png" },
      { url: "/darinol-icon-144.png", sizes: "144x144", type: "image/png" },
      { url: "/darinol-icon-192.png", sizes: "192x192", type: "image/png" },
      { url: "/darinol-icon-512.png", sizes: "512x512", type: "image/png" },
    ],
    shortcut: "/favicon.ico",
    apple: "/darinol-icon-180.png",
    other: [
      {
        rel: "mask-icon",
        url: "/darinol-icon-512.png",
        color: "#FF7A45",
      },
    ],
  },
